...
| POST | `/api/wallet/withdraw` | `wallet.api.ts` | implemented — advisor demo payout (platform fee deducted) |
| GET | `/api/wallet/withdraw/fee-rate` | `wallet.api.ts` | implemented — advisor fee percent |
